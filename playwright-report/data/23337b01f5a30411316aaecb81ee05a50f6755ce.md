...
- Name: landing-page.spec.ts >> Freelancer Planning Landing Page >> should show CTA sections as user scrolls deeper
- Location: tests\landing-page.spec.ts:45:3
...
Locator: getByText(/ELIMINATE SCOPE CREEP/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/ELIMINATE SCOPE CREEP/i)
