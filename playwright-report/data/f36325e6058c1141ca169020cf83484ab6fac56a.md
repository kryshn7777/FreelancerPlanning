...
- Name: landing-page.spec.ts >> Freelancer Planning Landing Page >> should reveal the dashboard mockup
- Location: tests\landing-page.spec.ts:35:3
...
Call log:
  - waiting for locator('section').filter({ has: locator('.perspective-1000') })
