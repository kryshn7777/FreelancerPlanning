...
- Name: landing-page.spec.ts >> Freelancer Planning Landing Page >> should reveal feature grid cards on scroll
- Location: tests\landing-page.spec.ts:22:3
...
Call log:
  - waiting for locator('section').filter({ hasText: 'Smart Planning' })
